...
-- Database: `ticket_me`
--
CREATE DATABASE IF NOT EXISTS `ticket_me` DEFAULT CHARACTER SET latin1 COLLATE latin1_swedish_ci;
USE `ticket_me`;
...
(2, 'Display', 'I can??t rotate my screen', 'You can rotate the screen to portrait or upside-down landscape, by hitting CTRL + ALT + Left Arrow, Right Arrow or Down arrow'),
...
--
-- Table structure for table `superticket`
--
...
--
-- Dumping data for table `superticket`
--
...
(2, 'wireless network', 'print anything with computer', 'Have you checked if it??s on? And connected to the wifi?'),
...
(4, 'software', 'can??t run my code in java application because it doesn??t accept the java environment ', 'your java path and java environment have to match to be able to work'),
(5, 'freebox', 'can\'t connect with internet but\r\nhave already fix the box', '1)check your mode of box\r\n2)If your network connection light is red, please unplug your Box 4G + and place it somewhere else in your home.\r\n3??If the phenomenon persists, please contact their support services by phone.'),
...
(8, 'gmail', ' how can  change gmail settings,I can??t find it', 'On your computer, go to Gmail.\r\nIn the top right, click Settings'),
(9, 'microsoft', 'What if dont\'t have enough disk space for the update?', 'Try deleting files you don??t need, uninstalling apps you don??t use, or moving '),
...
(2, 'Log-in', 'Low', 'pc', 'I have written my username and password but i still can??t log in', '', 0, 'try turning off your caps lock before writing your password', 'training', NULL, 'apratton24', 'svaanm'),
...
(5, 'printer is not working', 'Medium', 'wireless network', 'i can??t print anything with my computer because its not working', '', 0, 'Have you checked if it??s on? And connected to the wifi?', 'training', 2, 'apratton24', 'imorsleyl'),
(6, 'noise', 'Medium', 'pc', 'my computer is making grinding noise', '', 1, NULL, NULL, NULL, 'apratton24', NULL),
(7, 'slow internet', 'Low', 'wireless network', 'i can??t load my projects because the internet is so slow', '', 0, 'check out your computer if there are viruses or spywares and always install an antivirus software', 'training', 2, 'fmaslen25', 'imorsleyl'),
(8, 'can??t connect to the network', 'Low', 'wireless network', 'the wireless network keeps kicking me off', '', 0, 'your router may be overloaded, try to connect to another router', 'training', NULL, 'khaselden26', 'imorsleyl'),
(9, 'USB device not recognized', 'Low', 'pc', 'my computer doesn??t recognize my usb driver', '', 0, 'try to use another port if it still doesn??t work try putting it on someone else??s computer to check if its not broken', 'training', NULL, 'fmaslen25', 'abid_persondissk'),
...
(15, 'adobt reader updated problem', 'Low', 'pc', 'I don??t have the adnibistration rights for updating adobe reader what should i do', '', 0, 'The move to cloud-based service desk software helps cut down on these calls, because the updates are installed automatically. You can also release formal announcements and notifications of upcoming changes to software and/or applications through the portal.', 'training', NULL, 'khaselden26', 'dbirneyj'),
...
(19, 'document acces', 'Low', 'pc', 'i can??t acces to my documents', '', 0, 'change hardware or applications, employees need to know how to access their documents in the new hardware/software environment.', 'training', NULL, 'ltucker27', 'dbirneyj'),
(20, 'third-party software problems', 'High', 'pc', 'i can??t use third party applications I have so many problems, please help me as fast as you can because I need to finish my project as soon as possible and i need that third party application', '', 0, 'To prevent these problems, many organizations deny administrative rights to employees wanting to install their own third-party software. In addition, we recommend tracking every detail about every device through a comprehensive IT asset management strategy', 'training', NULL, 'ltucker27', 'itollfreei'),
...
(24, 'my apache is not working', 'High', 'software', 'i can??t connect myself to my database because my apache is not working after I installed new version of windows', '', 1, NULL, NULL, NULL, 'glegrand29', NULL),
(25, 'java environment not working', 'Low', 'software', 'i can??t run my code in java application because it doesn??t accept the java environment', '', 0, 'your java path and java environment have to match to be able to work', 'training', 4, 'kdecort28', 'itollfreei'),
(26, 'keayboard not working', 'Low', 'pc', 'My keyboard isn??t inputing anything on my computer even though it works on other computers', '', 0, 'try to clean up your keyboard port', 'training', NULL, 'cvooght2a', 'itollfreei'),
...
(28, 'Video stuck during upload', 'low', 'youtube', 'My video always stuck during upload ,and I  don??t know how to do', '', 1, NULL, NULL, NULL, 'jnareq', ''),
(29, 'Troubleshoot video takedowns', 'Medium', 'youtube', 'I??am a youtuber and my video is taken down but I don??t know why', '', 0, 'Your video was removed from YouTube because a copyright owner sent us a complete legal request to take it down. You also received a copyright strike. Learn how copyright strikes can affect your account.', 'solved with a workaround', NULL, 'blid_persongettu', 'atewnion5'),
(30, 'Saving chat history', 'Low', 'whatsapp', 'I can??t find button to save my history of chat', '', 1, NULL, NULL, NULL, 'nmitchelyn', ''),
...
(39, 'Space Drive', 'High', 'microsoft', '\nWhat if I don\'t have enough disk space for the update?', '', 0, 'Try deleting files you don??t need, uninstalling apps you don??t use, or moving files to another drive like an external USB drive or OneDrive. For more tips on freeing up disk space, see Free up drive space in Windows 10.', 'solved with a workaround', 9, 'ahefnert', 'atewnion5'),
...
(43, 'Windows Update', 'Medium', 'microsoft', '\r\n\r\nI want to stop downloading from or uploading to other PCs on the local network but I don??t know how to do that ,can you help me?\r\n\r\n', '', 1, NULL, NULL, NULL, 'tmarcinkowski19', NULL),
...
(48, 'Connect to network', 'Medium', 'internet', 'I can\'t Connect to the Home WiFi Network,and I dont??t know how o do ,would you please help me?', '', 0, 'Follow these steps to determine whether the issue is with your login credentials, the device or your network. The links will provide additional tips.\n:Login Credentials,Device Issues,Networdk issues', '', 10, 'dpretsell11', 'vhabberjam8'),
...
--
-- AUTO_INCREMENT for table `superticket`
--
ALTER TABLE `superticket`
